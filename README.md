...
<p align="center">跨平台的听力材料编辑与合成工具，支持小语种听力制作，满足新高考需求。</p>

---

## 简介

亿方听力大师（InspireWorks ListextEditor）是一款面向 K12 英语教学场景的听力材料制作工具，由亿方运维开发组开发。它把听力文本的编排、停顿、重复、音效和角色发音整合在一个编辑器里，帮助老师高效率地制作出完整的听力音频。
...
本工具面向教学与听力材料制作场景，建议在受控环境中使用并定期备份项目文件。本工具使用了国内可访问的合法 AI 模型，用户使用本工具制作的任何内容与本项目无关，不代表本项目立场。项目中提供的素材文件系网络搜集制作，禁止用于商业化场景，如有侵权请联系删除。
